...
const ControlBar = ({
    ...
    return (
        <div className="control-bar-container" style={{
            height: '80px',
            display: 'flex',
            alignItems: 'center',
            ...
            <button
                ...
                style={{ width: '64px', height: '64px' }} // Larger primary button
            >
                {isListening ? (
            ...
            <button
                ...
                title="End Interview"
                style={{ width: 'auto', padding: '0 2rem', borderRadius: '99px', gap: '0.5rem' }}
            >
                ...
                <span style={{ fontWeight: 600 }}>End Session</span>
            </button>
        </div>
    );
};
